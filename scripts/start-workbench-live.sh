...
export AI_CONTROL_WORKBENCH_CHILD_WORKER_COMMAND="${AI_CONTROL_WORKBENCH_CHILD_WORKER_COMMAND:-$REPO_ROOT/scripts/run-codex-proxy-child-worker.sh}"
export AI_CONTROL_WORKBENCH_CHILD_WORKER_ARGS_JSON="${AI_CONTROL_WORKBENCH_CHILD_WORKER_ARGS_JSON:-[\"{prompt_file}\"]}"
export AI_CONTROL_WORKBENCH_CHILD_WORKER_TIMEOUT_MS="${AI_CONTROL_WORKBENCH_CHILD_WORKER_TIMEOUT_MS:-1800000}"
export AI_CONTROL_WORKBENCH_CHILD_WORKER_MAX_ATTEMPTS="${AI_CONTROL_WORKBENCH_CHILD_WORKER_MAX_ATTEMPTS:-1}"
export AI_CONTROL_WORKBENCH_CHILD_WORKER_OUTPUT_PATH="${AI_CONTROL_WORKBENCH_CHILD_WORKER_OUTPUT_PATH:-tmp/workbench-child-workers/{run_id}-{cycle_id}-{work_package_id}.json}"
