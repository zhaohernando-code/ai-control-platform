...
export AI_CONTROL_WORKBENCH_REQUIREMENT_PLAN_COMMAND="${AI_CONTROL_WORKBENCH_REQUIREMENT_PLAN_COMMAND:-/Users/hernando_zhao/codex/start-claude-deepseek-no-proxy.sh}"
export AI_CONTROL_WORKBENCH_REQUIREMENT_PLAN_MODEL="${AI_CONTROL_WORKBENCH_REQUIREMENT_PLAN_MODEL:-deepseek-v4-pro[1m]}"
export AI_CONTROL_WORKBENCH_REQUIREMENT_PLAN_COMMAND_SUPPORTS_MODEL_ARG="${AI_CONTROL_WORKBENCH_REQUIREMENT_PLAN_COMMAND_SUPPORTS_MODEL_ARG:-0}"
export AI_CONTROL_WORKBENCH_REQUIREMENT_PLAN_COMMAND_SUPPORTS_ROLE_ARG="${AI_CONTROL_WORKBENCH_REQUIREMENT_PLAN_COMMAND_SUPPORTS_ROLE_ARG:-0}"
