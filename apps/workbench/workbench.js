...
const RAW_TOKEN_COPY = new Map([
  ...
  ["no_dispatchable_scheduler_actions", "暂无可派发调度动作"],
  ["wait_for_new_work", "等待新的可执行任务"],
  ["autonomous_scheduler_loop_run", "自动调度循环"],
  ["scheduler loop found no dispatchable actions", "调度循环未发现可派发动作"],
  ["PoolIterationClosed", "调度轮次已关闭"],
  ["WorkerCompleted", "子任务已完成"],
  ["WorkerEvaluation", "子任务已评估"],
  ["WorkerClosed", "子任务已关闭"],
  ["all gates, reviews, artifacts, and work packages", "所有门禁、审查、证据和任务包"],
  ["work packages", "任务包"],
  ["artifacts", "证据"],
