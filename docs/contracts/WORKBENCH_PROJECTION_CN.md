...
- PC projection 必须包含 manifest、artifacts、closeout、resume health、reviewer provider health、scheduler dispatch、scheduler loop、operations timeline、model routing、reviewer gate、autonomous run、task DAG 和 one-screen 摘要。
- Mobile projection 必须包含 headline、counters、next actions、closeout、resume health、provider health、scheduler dispatch、scheduler loop、operations timeline、model 和 reviewer 摘要。
