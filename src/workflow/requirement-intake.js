...
function isClosedRequirementStatus(value = "") {
  return ["completed", "complete", "accepted", "closed"].includes(normalizeString(value).toLowerCase());
}
...
function withoutRequirementWorkPackages(workPackages = [], requirementId = "") {
