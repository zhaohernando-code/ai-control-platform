...
export const WORKBENCH_SERVER_TEST_FILES = ["test/workbench-server.test.js", "test/workbench-server-agent-key-routes.test.js", "test/workbench-server-cli.test.js", "test/workbench-server-project-status-continuation.test.js", "test/workbench-server-requirement-plan-generation.test.js", "test/workbench-server-shard-01.test.js", "test/workbench-server-shard-02.test.js", "test/workbench-server-shard-03.test.js", "test/workbench-server-shard-04.test.js", "test/workbench-server-shard-05.test.js", "test/workbench-server-shard-06.test.js", "test/workbench-server-shard-07.test.js", "test/workbench-server-shard-08.test.js", "test/workbench-server-shard-09.test.js", "test/workbench-server-shard-10.test.js", "test/workbench-server-shard-11.test.js"];
